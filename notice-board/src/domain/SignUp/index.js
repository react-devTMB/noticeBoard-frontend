      ...
      <Form className="login-form">
        ...
        <div className="login-form-02">
          ...
          <FormGroup>
            ...
            <Input type="text" name="name" placeholder="nickName" value={name} onChange={onChangeName} />
          </FormGroup>
          <FormGroup>
          ...
          <FormGroup className="form-group_02">
            <Input type="password" name="passwordConfirm" placeholder="PasswordConfirm" onChange={onChangePassword} />
          </FormGroup>
          <p className="chk_validate">{errorTxt}</p>
          <Button disabled={!enabled.checkName || !enabled.checkEmail || !enabled.checkPassword || !enabled.checkPasswordConfirm} className="btn-lg btn-dark btn-block" onClick={handleOnSubmit}>
            Sign Up
          </Button>
        </div>
      </Form>
